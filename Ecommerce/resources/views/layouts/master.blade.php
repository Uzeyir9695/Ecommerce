        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
                <div class="search-input">
                    ...
                    <input class="form-control input" type="text" placeholder="Something..." tabindex="-1" data-search="search">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right ">
                    ...
                    <li class="dropdown-menu-footer">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            {{--                                <input type="text" class="no-outline total-price" name="total_price" readonly style="border: hidden; width: 60px; font-weight: bold" value="0">--}}
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a class="dropdown-item" href="page-profile.html"><i class="mr-50" data-feather="user"></i> Profile</a>
                    ...
                    <a class="dropdown-item" href="{{ route('stores.index') }}"><i class="mr-50" data-feather="home"></i>My Stores</a>
                    <a class="dropdown-item" href="{{ route('products.index') }}"><i class="mr-50" data-feather="home"></i> My Products</a>
